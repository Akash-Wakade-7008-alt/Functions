...
public class Main
{
	public static void main(String[] args) {
	  ...
	  double numerator=pmf.exponentialFunction(pmf.lambda)*pmf.powerFunction(pmf.lambda,pmf.r);     
	  double denominator = pmf.factorial(pmf.r);
	 
	  double output =numerator/denominator;
	 
	  System.out.printf("PMF is : %.2f",output);
